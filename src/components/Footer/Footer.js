...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-primary text-white text-base-content">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-primary text-white text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>LOYAL Parts Ltd. <br />Providing reliable tech since 1992</p>
                </div>
